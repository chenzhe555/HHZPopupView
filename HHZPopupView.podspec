#
#  Be sure to run `pod spec lint HHZPopupView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-HHZPopupView"

  s.homepage     = "https://github.com/chenzhe555/HHZPopupView"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZPopupView.git", :tag => "#{s.version}" }
